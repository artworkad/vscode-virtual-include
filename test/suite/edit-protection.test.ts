  ...
  test('Protected region cannot be edited', async () => {
    ...
    edit.replace(
      ...
      new vscode.Range(
        ...
        new vscode.Position(protectedLineIndex, lines[protectedLineIndex].length)
      ),
    ...
    assert.strictEqual(updatedLines[protectedLineIndex], originalContent, 'Edit protection failed');
