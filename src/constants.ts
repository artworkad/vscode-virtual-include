...
export class Constants {
  ...
  public static readonly VIRTUAL_INCLUDE_REGEX = /^\s*# virtualInclude\s+["'](.+?)["']\s*$/;

  // Markers used to indicate the beginning and end of included content
  public static readonly PROTECTED_SECTION_START = '# virtualIncludeStart - DO NOT EDIT CONTENT BELOW';
  public static readonly PROTECTED_SECTION_END = '# virtualIncludeEnd - DO NOT EDIT CONTENT ABOVE';
  ...
  public static getStartMarker(): string {
    ...
    return config.get<string>(Constants.CONFIG_START_MARKER, Constants.PROTECTED_SECTION_START);
  }
  ...
  public static getEndMarker(): string {
    const config = Constants.getConfiguration();
    return config.get<string>(Constants.CONFIG_END_MARKER, Constants.PROTECTED_SECTION_END);
  }
