...
export class LanguageService {
    ...
    public static getCommentStyle(languageId: string): CommentStyle {
        const defaultStyle = Constants.getConfiguration().get('defaultCommentStyle', '#');
    ...
    public static getLanguageSettings(languageId: string): LanguageSettings {
        ...
        const allLanguageSettings = config.get<Record<string, LanguageSettings>>('languageSettings', {});
     ...
     * @returns LanguageSettings
     */
    private static createDefaultSettings(commentStyle: CommentStyle): LanguageSettings {
